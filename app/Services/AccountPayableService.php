    ...
    public function create(array $data, Tenant $tenant): AccountPayable
    {
        return $tenant->run(function () use ($data) {
            return DB::transaction(function () use ($data) {
                $data['financial_contact_id'] = $this->resolveFinancialContactId($data['financial_contact_id'], ContactTypeEnum::SUPPLIER);
                ...
                if (!empty($data['installments'])) {
                    ...
                    $this->generateInstallments($accountPayable, $data, $data['valor']);
                }
