...
{
    public function findAll($request, string $period)
    {
    ...
    static public function getAccounts(string $model, string $start, string $end, $request)
    {
        return $model::with([
            ...
            $query->whereHas('categoryFinancial', function (Builder $query) use ($request) {
    ...
    public function totalPeriod($request, string $period, ?int $accountBankId = null)
    {
        $start = $request->query('start')
            ? Carbon::parse($request->query('start'))->startOfDay()
            : Carbon::createFromFormat('Y-m', $period)->startOfMonth();
    ...
    public function expenses($request, string $period, ?int $accountBankId = null)
    {
        $start = $request->query('start')
            ? Carbon::parse($request->query('start'))->startOfDay()
            : Carbon::createFromFormat('Y-m', $period)->startOfMonth();
    ...
    public function revenues($request, string $period, ?int $accountBankId = null)
    {
        $start = $request->query('start')
            ? Carbon::parse($request->query('start'))->startOfDay()
            : Carbon::createFromFormat('Y-m', $period)->startOfMonth();
    ...
    public function calculateAccounts($request, string $period, ?int $accountBankId = null)
    {
        $start = $request->query('start')
            ? Carbon::parse($request->query('start'))->startOfDay()
            : Carbon::createFromFormat('Y-m', $period)->startOfMonth();
