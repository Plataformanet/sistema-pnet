...
<template>
    <div>
        ...
        <form @submit.prevent="submit">
            ...
            <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-5 cursor-pointer disabled:opacity-50" type="submit" :disabled="form.processing">
                Entrar
            </button>
        </form>
    </div>
