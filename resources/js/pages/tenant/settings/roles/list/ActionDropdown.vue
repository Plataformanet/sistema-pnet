    ...
    <div>
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem
                    v-if="permissions.includes('settings.roles.view')"
                    @click="console.log('Visualizar', role.id)"
                >
                    <Eye class="mr-2 h-4 w-4" /> Visualizar
                </DropdownMenuItem>
                <DropdownMenuItem
                    as-child
                    v-if="permissions.includes('settings.roles.edit')"
                >
                    <Link
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem
                    v-if="permissions.includes('settings.roles.delete')"
