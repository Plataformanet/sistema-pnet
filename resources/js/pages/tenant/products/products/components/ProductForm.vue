        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <Field>
                    ...
                    <FieldError v-if="form.errors.sku">{{ form.errors.sku }}</FieldError>
                </Field>

                <Field>
                    <FieldLabel for="barcode">Código de Barras (EAN/GTIN)</FieldLabel>
                    <Input id="barcode" v-model="form.barcode" />
                    <FieldError v-if="form.errors.barcode">{{ form.errors.barcode }}</FieldError>
                </Field>

                <Field>
                    <FieldLabel for="category_id">Categoria do Produto</FieldLabel>
                    <Select v-model="form.category_id">
                        ...
                        <SelectContent>
                            <SelectGroup>
                                <SelectItem value="1">Informática / Computadores</SelectItem>
                                <SelectItem value="2">Periféricos</SelectItem>
                                <SelectItem value="3">Suprimentos e Papelaria</SelectItem>
                            </SelectGroup>
                        </SelectContent>
                    </Select>
                    <FieldError v-if="form.errors.category_id">{{ form.errors.category_id }}</FieldError>
                </Field>
                
                <Field>
                    <FieldLabel for="unit_of_measure">Unidade de Medida</FieldLabel>
                    ...
                    <FieldError v-if="form.errors.unit_of_measure">{{ form.errors.unit_of_measure }}</FieldError>
                </Field>
            </div>
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <Field>
                    ...
                    <Input
                        ...
                        placeholder="R$ 0,00"
                    />
                    <FieldError v-if="form.errors.cost_value">{{ form.errors.cost_value }}</FieldError>
                </Field>
                ...
                <Field>
                    ...
                    <Input
                        ...
                        placeholder="R$ 0,00"
                    />
                    <FieldError v-if="form.errors.sell_value">{{ form.errors.sell_value }}</FieldError>
                </Field>
            </div>
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                <Field>
                    <FieldLabel for="manage_stock">Controla Estoque?</FieldLabel>
                    <Select :model-value="form.manage_stock ? '1' : '0'" @update:model-value="form.manage_stock = $event === '1'">
                    ...
                    <FieldError v-if="form.errors.manage_stock">{{ form.errors.manage_stock }}</FieldError>
                </Field>

                <Field>
                    <FieldLabel for="current_stock">Estoque Atual</FieldLabel>
                    <Input id="current_stock" type="number" v-model="form.current_stock" :disabled="!form.manage_stock" />
                    <FieldError v-if="form.errors.current_stock">{{ form.errors.current_stock }}</FieldError>
                </Field>

                <Field>
                    <FieldLabel for="min_stock">Estoque Mínimo</FieldLabel>
                    <Input id="min_stock" type="number" v-model="form.min_stock" :disabled="!form.manage_stock" />
                    <FieldError v-if="form.errors.min_stock">{{ form.errors.min_stock }}</FieldError>
                </Field>
            </div>
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <Field class="md:w-1/2">
                    ...
                    <FieldError v-if="form.errors.active">{{ form.errors.active }}</FieldError>
                </Field>
            </div>
        </div>
