  ...
  <DropdownMenu>
    ...
    <DropdownMenuContent align="end">
      ...
      <DropdownMenuItem as-child>
        <Link :href="route('tenant.registrations.employees.edit', employee.id)" class="w-full flex cursor-pointer items-center">
            <Pencil class="mr-2 h-4 w-4" /> Editar
        </Link>
      </DropdownMenuItem>
      <DropdownMenuSeparator />
      <DropdownMenuItem @click="console.log('Excluir', employee.id)" class="text-red-600">
