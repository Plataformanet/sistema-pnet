...
const isEdit = computed(() => !!props.accountReceivable);

// Installments list for individual editing (used in Edit mode)
const localInstallments = ref<any[]>(
    props.accountReceivable?.installments?.map((inst: any) => ({
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <Field class="md:col-span-2">
                    ...
                    <Input
                        ...
                        placeholder="Ex: Prestação de Serviços de TI, Venda de Equipamentos"
                        required
                    />
