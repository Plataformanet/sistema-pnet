...
Route::middleware([
    ...
    Route::middleware(Authenticate::class)->group(function () {
        ...
        // Users
        Route::get('/registrations/users/list', [App\Http\Controllers\TenantUserController::class, 'userList'])->name('tenant.registrations.users.list');
        Route::get('/registrations/users/create', [App\Http\Controllers\TenantUserController::class, 'userCreate'])->name('tenant.registrations.users.create');
        Route::get('/registrations/users/{id}/edit', [App\Http\Controllers\TenantUserController::class, 'userEdit'])->name('tenant.registrations.users.edit');
        Route::put('/registrations/users/{id}', [App\Http\Controllers\TenantUserController::class, 'userUpdate'])->name('tenant.registrations.users.update');
